...
evt,true);if(this._map)this._map.fire("eledata_loaded",evt,true)},this);if(this._map)this.layer.addTo(this._map);else console.warn("Undefined elevation map object")}.bind(this,data))},onAdd:function(map){this._map=map;var opts=this.options;var container=this._container=L.DomUtil.create("div","elevation-control elevation");if(!this.options.detached)L.DomUtil.addClass(container,"leaflet-control");if(this.options.theme)L.DomUtil.addClass(container,opts.theme);var isJSLoaded=typeof d3!=="object"&&this.options.lazyLoadJS&&
!L.Control.Elevation._d3LazyLoader;L.Control.Elevation._d3LazyLoader=this._lazyLoadJS("https://unpkg.com/d3@4.13.0/build/d3.min.js",!isJSLoaded);L.Control.Elevation._d3LazyLoader.then(function(map,container){this._initToggle(container);this._initChart(container);this._applyData();this._map.on("zoom viewreset zoomanim",this._hidePositionMarker,this);this._map.on("resize",this._resetView,this);this._map.on("resize",this._resizeChart,this);this._map.on("mousedown",this._resetDrag,this);this._map.on("eledata_loaded",
