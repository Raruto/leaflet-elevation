...
1. **include CSS & JavaScript**
    ...
    <!-- leaflet-elevation -->
    <link rel="stylesheet" href="https://unpkg.com/@raruto/leaflet-elevation@0.2.1/leaflet-elevation.css" />
    <script src="https://unpkg.com/@raruto/leaflet-elevation@0.2.1/leaflet-elevation.js"></script>
    ...
    </head>
    ```
