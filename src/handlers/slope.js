  ...
  return {
    ...
    summary: {
      minslope: {
        label: "Min Slope: ",
        value: (track, unit) =>
          Math.round(track.slope_min || 0) + "&nbsp;" + unit,
        order: 40,
      },
      maxslope: {
        label: "Max Slope: ",
        value: (track, unit) =>
          Math.round(track.slope_max || 0) + "&nbsp;" + unit,
        order: 41,
      },
      avgslope: {
        label: "Avg Slope: ",
        value: (track, unit) =>
          Math.round(track.slope_avg || 0) + "&nbsp;" + unit,
        order: 42,
      },
      ascent: {
        label: "Total Ascent: ",
        value: (track, unit) =>
          Math.round(track.ascent || 0) +
          "&nbsp;" +
