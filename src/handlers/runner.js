...
export async function Runner() {
  ...
  this.addCheckpoint = function (checkpoint) {
    return this._registerCheckPoint({
      // <-- NB these are private functions use them at your own risk!
  ...
  this.updateRunnerPos = function (runner, pos) {
    ...
    runner.attr("cx", x).attr("cy", this._y(curr.z));
  ...
  this.animate = function (layer, speed = 1500) {
    ...
    const geo = L.geoJson(layer.toGeoJSON(), {
