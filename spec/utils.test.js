...
test('iMax()', () => {
    ...
    max = iMax(0, max);         assert.is(toFixed(max), 100); // max for [100, 0] is 100
    max = iMax(-200, max);      assert.is(toFixed(max), 100); // max for [100, 0, -200] is 100
    max = iMax(200, max);       assert.is(toFixed(max), 200); // max for [100, -100, -200, 200] is 200
});
...
test('iSum()', () => {
    ...
    sum = iSum(-0.25, sum);       assert.is(toFixed(sum), 10);    // sum for [100, 0, -0.25] is 10
    sum = iSum(-10, sum);         assert.is(toFixed(sum), 0);     // sum for [100, 0, -0.25, -10] is 0
});
